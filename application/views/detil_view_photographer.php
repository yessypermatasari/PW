...
<body>
						...
						<ul class="nav navbar-nav link-effect-4">
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
									<li><a href="<?php echo base_url() ?>index.php/photographer">Pembawa Acara</a></li>
									<li><a href="<?php echo base_url() ?>index.php/photographerAcara">Pengisi Acara</a></li>
	...
	<div class="container2ku">
		...
		<div class="row">
			<div class="col-md-4">
			<a href="<?php echo base_url() ?>uploads/<?php echo $barang->gambar_photographer;?>" class="thumbnail" data-fancybox-group="group1" title="Description 1"><img alt="" src="<?php echo base_url() ?>uploads/<?php echo $barang->gambar_photographer;?>"></a>
			</div>
			<div class="col-md-8">
				<address>
					<strong>Nama:</strong> <span><?php echo $barang->nama_photographer; ?></span><br>							
				</address>									
				<h4><strong>Price: <?php echo $barang->harga_photographer; ?></strong></h4>
				...
				<div class="">
					...
					<div class="tab-content">
						<div class="tab-pane active" id="home"><?php echo $barang->deskripsi_photographer; ?></div>				
				</div>	
			</div>
		</div>
	</div>
