...
<body>
						...
						<ul class="nav navbar-nav link-effect-4">
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
									...
									<li><a href="<?php echo base_url() ?>index.php/mcAcara">Pengisi Acara</a></li>
	...
	<div class="container2ku">
		...
		<div class="row">
			<div class="col-md-4">
			<a href="<?php echo base_url() ?>uploads/<?php echo $barang->gambar_mc;?>" class="thumbnail" data-fancybox-group="group1" title="Description 1"><img alt="" src="<?php echo base_url() ?>uploads/<?php echo $barang->gambar_mc;?>"></a>
			</div>
			<div class="col-md-8">
				<address>
					<strong>Nama:</strong> <span><?php echo $barang->nama_mc; ?></span><br>							
				</address>									
				<h4><strong>Price: <?php echo $barang->harga_mc; ?></strong></h4>
				...
				<div class="">
					...
					<div class="tab-content">
						<div class="tab-pane active" id="home"><?php echo $barang->deskripsi_mc; ?></div>				
				</div>	
			</div>
		</div>
	</div>
