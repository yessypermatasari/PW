...
<body>
	...
	<div class="container2ku">
		...
		<div class="row">
			<div class="col-md-4">
			<a href="<?php echo base_url() ?>uploads/<?php echo $barang->gambar_avenue;?>" class="thumbnail" data-fancybox-group="group1" title="Description 1"><img alt="" src="<?php echo base_url() ?>uploads/<?php echo $barang->gambar_avenue;?>"></a>
			</div>
			<div class="col-md-8">
				<address>
					<strong>Nama:</strong> <span><?php echo $barang->nama_avenue; ?></span><br>							
				</address>									
				<h4><strong>Price: <?php echo $barang->harga_avenue; ?></strong></h4>
				...
				<div class="">
					...
					<div class="tab-content">
						<div class="tab-pane active" id="home"><?php echo $barang->deskripsi_avenue; ?></div>				
				</div>	
			</div>
		</div>
	</div>
